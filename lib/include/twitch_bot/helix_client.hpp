...
/**
 * @brief Represents the result of querying "/helix/streams?user_login=..."
...
/**
 * @brief A minimal Helix OAuth + Streams client.
 *
 * Usage pattern:
...
public:
    /**
     * @brief Construct a HelixClient using the given I/O and SSL contexts.
     *
    ...
    /**
     * @brief If there's no token yet, or if it's expired, obtain a new one
    ...
    /**
     * @brief Once `ensureToken()` has been called successfully, do GET
