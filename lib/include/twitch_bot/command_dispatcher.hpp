...
using chat_listener_t   = std::function<void(std::string_view channel,
...
public:
  ...
  void register_command(std::string_view command,
...
private:
  ...
  static TB_FORCE_INLINE
  std::string_view normalize_channel(std::string_view raw) noexcept
  {
  ...
  static TB_FORCE_INLINE
  std::string_view extract_user(std::string_view prefix) noexcept
  {
  ...
  static TB_FORCE_INLINE
  void split_command(std::string_view text,
